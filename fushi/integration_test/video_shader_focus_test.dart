  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      try {
        ...
        final Anime4kPreset modeA = kAnime4kPresets.firstWhere(
        ...
        final Anime4kDownloadResult dl = await downloadAnime4kFiles(
          modeA,
          dio: proxiedDio,
        );
        debugPrint(
          '[video-shader] Anime4K download: '
        ...
        if (dl.downloaded.isNotEmpty) {
          ...
          final File first = File(
            '${shaderDir.path}\\Anime4K_Clamp_Highlights.glsl',
          );
          expect(
            first.existsSync(),
            isTrue,
          ...
          debugPrint(
            '[video-shader] download produced no files '
        ...
        debugPrint(
          '[video-shader] focus during dialog: '
