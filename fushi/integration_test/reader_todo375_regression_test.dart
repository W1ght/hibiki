  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      try {
        ...
        final String? resolvedUid = await appModel.database.resolveEpubBookUid(
          bookKey,
        );
        expect(
          resolvedUid,
        ...
        final ReaderPositionRepository posRepo = ReaderPositionRepository(
          appModel.database,
        );
        ...
        final NavigatorState navOpen = tester.state<NavigatorState>(
        ...
        expect(
          ...
          greaterThan(0),
          reason:
              'sym3/page-turn path: paginate("forward") must scroll at '
        ...
        debugPrint(
          '[t375] saved DB: section=${saved?.sectionIndex} '
        ...
        expect(
          ...
          0,
          reason:
              'sym2: in-chapter page turns must NOT jump chapter '
        ...
        expect(
          ...
          isNotNull,
          reason:
              'sym1: same-section save must preserve a precise charOffset '
        ...
        debugPrint(
          '[t375] after-close DB: section=${afterClose?.sectionIndex} '
          'charOffset=${afterClose?.charOffset}',
        );
        expect(afterClose?.sectionIndex, 0);
        expect(
          afterClose?.charOffset,
          isNotNull,
        ...
        final NavigatorState navOpen2 = tester.state<NavigatorState>(
          find.byType(Navigator).first,
        );
        unawaited(
          navOpen2.push<void>(
        ...
        expect(
          ...
          greaterThan(0),
          reason:
              'sym3: continuous/scroll mode paginate("forward") must '
              'still turn pages (was reported broken).',
        );
        debugPrint(
          '[t375][continuous] === PASSED: scroll-mode page turn alive '
        ...
        debugPrint(
          '[t375] === PASSED: section kept + precise charOffset '
