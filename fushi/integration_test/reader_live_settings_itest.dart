...
/// BUG-2461 / BUG-2460 真 app 证据（Windows 离屏 runner / Mac 跨机，真 WebView + 真引擎）。
///
/// A. BUG-2461 —— 开着阅读器改「上边距」偏好（与设置页 slider 同一 setter
...
///
/// B. BUG-2460 —— 状态行贴屏底：`fushi_status_footer` 的底边 == 窗口底边，带高 ==
...
void main() {
  ...
  testWidgets(
    'BUG-2461: margin / gesture settings hot-update the running engine; '
    'BUG-2460: status footer sits on the screen bottom inside the safe area',
      ...
      await runFushiItest(
        ...
        body: () async {
          ...
          try {
            ...
            // ── B. BUG-2460：状态行贴屏底、带高 = max(28, 系统底 inset) ──
