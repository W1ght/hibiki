...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      debugPrint(
        '[reader-css-dom] computed font-size: '
      ...
      expect(
        ...
        greaterThan(at20),
        reason:
            'raising the font-size setting must raise the computed DOM '
  ...
  testWidgets(
    ...
    '2em end margin in the live WebView engine',
    (WidgetTester tester) async {
      final String popupJs = await rootBundle.loadString(
    ...
    ''',
      ...
      final double referenceOffset = (geometry['referenceOffset'] as num)
          .toDouble();
      ...
      expect(
        referenceGap.abs(),
        lessThan(1),
        reason: 'dictionary margin-inline-end must not leave a gap after gaiji',
      );
    },
  );
}
