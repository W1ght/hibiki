  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      try {
        ...
        debugPrint(
          '[desktop-settings] focus traversal reached '
        ...
        expect(
          ...
          reason:
              'Focus-driven Tab traversal must reach multiple real targets '
        ...
        final ReaderCssEffectProbe probe = ReaderCssEffectProbe(
        ...
        final String flipped = originalMode.startsWith('vertical')
            ? 'horizontal-tb'
            : 'vertical-rl';
        ...
        debugPrint(
          '[desktop-settings] effect changed=${verdict.changed} '
        ...
        debugPrint(
          '[desktop-settings] PASS — real app, hidden runner, focus '
