...
class FushiPopupSurface extends StatelessWidget {
  ...
  ///
  /// BUG-2159：改成「之前绘制」的代价是**不透明的子节点会把描边整条盖掉**。查词浮层
  ...
  /// BUG-2159：描边画在子节点之前（[borderOnForeground] = false）时，给子节点让出
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      ...
      child: _borderInsetChild(tokens, Padding(padding: padding, child: child)),
    );
  }
}
