...
class StudySegmentRecord {
  ...
  /// v100（统计按 Profile 隔离）：产生本段的 Profile **名字**（additive 字段；
  ...
  /// 墓碑键（与 [StudyTombstoneRecord.key] 同公式）：v100 起带 Profile 名，A
  /// Profile 的碑只压 A 的段。
...
///
/// v100：带 [profileName]（同 [StudySegmentRecord.profileName]）。落地时名字对不上
