...
extension _ReaderWebView on _ReaderFushiPageState {
  ...
  /// BUG-2461：设置热更新时下发给引擎的那一小份（[ReaderEngineConfig.liveUpdateInvocation]），
...
install: function(C) {
  ...
  window.__fushiApplyReaderMargins = function(width, height) {
    ...
    // BUG-2461: remember the viewport the margins were sized from so a live
...
// BUG-2461: hot-update the per-nav config without re-running install. `C`
