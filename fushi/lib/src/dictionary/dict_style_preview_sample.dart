    ...
    <Map<String, Object>>[
      <String, Object>{
        ...
        'deinflectionTrace': <Map<String, String>>[
          <String, String>{'name': '-させる', 'description': '使役形。動詞の未然形に接続する。'},
          <String, String>{'name': '-られる', 'description': '受身形。使役の未然形に接続する。'},
          <String, String>{'name': '-た', 'description': '過去・完了。連用形に接続する。'},
        ],
          ...
          <String, Object>{
            ...
            'content': <String, Object>{
              ...
              'content': <Map<String, Object>>[
                <String, Object>{'tag': 'span', 'content': '食物を口に入れ、かんで飲みこむ。'},
                <String, Object>{
                  'tag': 'div',
                  'content': <Map<String, Object>>[
