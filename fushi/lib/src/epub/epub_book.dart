...
class EpubBook {
  ...
  static List<String> _chapterImageRefs(html_dom.Document doc) {
    ...
    for (final Match match in backgroundImageUrlPattern.allMatches(
      css.toString(),
    )) {
  ...
  /// Public because [IllustrationProgressIndex] classifies the same references
  /// element by element — one pattern, not two drifting copies.
