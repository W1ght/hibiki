...
void main() {
  test('css editor section is bare and is the single call path', () {
    ...
    final int wrapperCalls = '_buildBookCssEditorSection()'
        .allMatches(sheet)
        .length;
    expect(
      wrapperCalls,
      greaterThanOrEqualTo(2),
      reason: 'normal + lyrics layout sub-pages both route through the wrapper',
    );
    final int bareRowSections = '<Widget>[_buildBookCssEditorRow()]'
        .allMatches(sheet)
        .length;
    expect(
      bareRowSections,
