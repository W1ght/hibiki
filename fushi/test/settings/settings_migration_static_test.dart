...
void main() {
  final Map<String, List<String>> migratedPages = <String, List<String>>{
    ...
    'anki_settings_page.dart': <String>['AdaptiveSettingsSection'],
    ...
    'miscellaneous_settings_page.dart': <String>['AdaptiveSettingsSection'],
  ...
  test('settings pages do not use legacy switch rows', () {
    for (final String fileName in noLegacySwitchRows) {
      ...
      expect(
        containsIdentifierCall(source, 'RadioListTile'),
        isFalse,
        reason: '$fileName still uses RadioListTile instead of settings rows',
      );
      expect(
        containsIdentifierCall(source, 'CupertinoListTile'),
        isFalse,
      ...
      expect(
        source,
        isNot(contains('adaptiveSegmentedButton')),
        reason: '$fileName still hand-rolls segmented controls',
      );
      expect(
        source,
        isNot(contains('adaptiveAppBar(')),
