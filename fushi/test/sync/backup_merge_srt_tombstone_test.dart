...
void main() {
  ...
  test('deleted book is not resurrected (no orphan srt) on MERGE', () async {
    final Directory srcRoot = await Directory.systemTemp.createTemp(
      'srtt_src_',
    );
    ...
    await BackupService.mergeRestoreBackup(dbDirectory: curDbDir, zipPath: zip);
