  ...
  group('BUG-160: server-enabled intent persists across bind failures', () {
    ...
    test(
      ...
      () {
        ...
        final int startIdx = src.indexOf(
        ...
        expect(
          setFalseInCatch.hasMatch(startBody),
          isFalse,
          reason: 'PortInUse 分支不得调用 setServerEnabled(false)（会抹掉用户意图）',
        );
        expect(
          setFalseInCatchGeneral.hasMatch(startBody),
          isFalse,
