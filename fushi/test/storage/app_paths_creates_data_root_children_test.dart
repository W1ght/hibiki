...
void main() {
  ...
  test('dataRoot 只有自己存在（安装向导刚建完）→ resolve() 必须把 documents / support '
    ...
    expect(
      Directory(p.join(dataRoot.path, 'support')).existsSync(),
      isFalse,
    ...
    expect(
      paths.documentsRoot.existsSync(),
      isTrue,
