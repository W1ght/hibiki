...
void main() {
  ...
  test(
    'online OCR starts at the visible page, retries images and reuses cache',
    () async {
      final Directory root = await Directory.systemTemp.createTemp(
        'hibiki-mihon-online-ocr-',
      );
      addTearDown(() async {
        if (await root.exists()) await root.delete(recursive: true);
      });
      final _OnlineImageRuntime runtime = _OnlineImageRuntime(
        Uint8List.fromList(img.encodePng(img.Image(width: 1200, height: 1700))),
      );
      ...
      final List<MangaOcrBackgroundEvent> firstEvents =
      ...
      expect(
        runtime.attempts[2],
        3,
        reason: 'page fetch retries are 350/700 ms',
      );
      ...
      expect(
        ...
        5,
        reason:
            'materialized page identities and disk page cache survive reopen',
      );
