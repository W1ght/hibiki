...
AudioCue _cue(String text, int startMs, int endMs, {SubtitleMarkup? markup}) =>
    AudioCue()
      ..bookKey = 'b'
      ..chapterHref = 'ch'
      ..sentenceIndex = 0
