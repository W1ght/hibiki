...
void main() {
  ...
  testWidgets('respectAssStyle ON: inline c/fn/3c apply; OFF: unified style wins', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets(
    'respectAssStyle ON: cueStyle default font/color/outline applied',
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      final AudioCue cue = cueFromMarkup(
        const SubtitleMarkup(
          plainText: 'S',
          spans: <SubtitleSpan>[],
          cueStyle: SubtitleCueStyle(
            shadowDepthPx: 3,
            shadowColorArgb: 0xFF112233,
          ),
        ),
      );
  ...
  testWidgets('respectAssStyle ON but no PlayResY: ASS font size used raw '
  ...
  testWidgets('respectAssStyle ON but no PlayResY: ASS outline width used raw '
      '(backward compatible) (TODO-1246)', (WidgetTester tester) async {
    final AudioCue cue = cueFromMarkup(
      const SubtitleMarkup(
        plainText: 'X',
  ...
  testWidgets(
    ...
    'Outline ignored (TODO-1246 / Niratan)',
    (WidgetTester tester) async {
      final AudioCue cue = cueFromMarkup(
        const SubtitleMarkup(
          plainText: 'X',
  ...
  test(
    r'assBlurValueToSigma applies libass 2/sqrt(ln256) factor (mpv parity)',
    () {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        ops.any((Opacity o) => (o.opacity - 0.5).abs() < 1e-6),
        isTrue,
