...
void main() {
  test(
    'third-party tvshow and episode NFO become structured work data',
    () async {
...
<plot>分集简介</plot><aired>2024-04-01</aired></episodedetails>''');
  ...
  test(
    'partial episode NFO overrides fields without deleting online episodes',
    () {
      ...
      expect(
        merged.seasons.first.episodes.first.ids.map(
          (VideoMetadataId id) => id.type,
        ),
