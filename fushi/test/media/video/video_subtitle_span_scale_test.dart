...
void main() {
  test('parser: static fscx is span-scoped', () {
    ...
    final SubtitleSpan prefix = m.spans.firstWhere(
      (SubtitleSpan s) => s.startGrapheme == 0,
    );
    expect(prefix.scaleX, closeTo(0.5, 1e-6));
    final SubtitleMarkup m2 = parseSubtitleMarkup(
      r'日用品が全然足りません{\fscx50}。',
      playResX: 960,
      playResY: 540,
    );
