...
void main() {
  ...
  group('TODO-057 video drag brightness/volume guards', () {
    test(
      'enables independent volume gesture and brightness-gated drag gesture',
      () {
    ...
    test(
      ...
      () {
        ...
        expect(
          videoPage.contains('seekGesture: false'),
          isFalse,
          reason:
        ...
        expect(
          containsCodeLine(videoPage, 'horizontalSeekResolver:'),
          isTrue,
        ...
        expect(
          videoPage.contains('_buildSeekIndicator(controller, delta)'),
          isTrue,
        );
      },
    );
    ...
    test('volume callback reuses the existing 0..100 volume channel', () {
      ...
      expect(
        videoPage.contains('onVolumeChanged: _onMediaKitVolumeChanged'),
        isTrue,
      );
    ...
    test(
      'right-side volume drag hides media_kit indicator and uses page HUD',
      () {
        final String body = mobileThemeBody();
        expect(
          body.contains('volumeIndicatorBuilder:'),
          isTrue,
          reason:
        ...
        expect(
          videoPage.contains('_showVolumeOsd(clamped)'),
          isTrue,
    ...
    test(
      ...
      () {
        final String body = mobileThemeBody();
        expect(
          body.contains('brightnessIndicatorBuilder:'),
          isTrue,
          reason:
        ...
        expect(
          videoPage.contains('_showBrightnessOsd(clamped * 100.0)'),
          isTrue,
