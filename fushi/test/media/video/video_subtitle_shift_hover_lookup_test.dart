...
void main() {
  ...
  group('TODO-756a video Shift-hover lookup', () {
    ...
    testWidgets(
      'throttle: same char small move no re-fire; new char re-fires',
      (WidgetTester tester) async {
        final List<_Hit> hovers = <_Hit>[];
        final VideoPlayerController c = _controllerWithCue('テスト');
        await _pump(
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await _pump(
          ...
          VideoSubtitleOverlay(
            controller: c2,
            onCharHover: (_, __, ___, AudioCue cueArg) {},
          ),
        );
    ...
    testWidgets(
      'shift-hover same chain as tap: same char -> identical triple',
      (WidgetTester tester) async {
