...
void main() {
  ...
  group('floatingLyricContextWindow', () {
    final List<AudioCue> five = cuesFrom(<String>[
      '行0',
      '行1',
      '行2',
      '行3',
    ...
    test('n=0 只返回当前行（单元素）', () {
      expect(floatingLyricContextWindow(cues: five, index: 2, n: 0), <String>[
        '行2',
      ]);
    });

    test('中段完整前后 N 行', () {
      expect(floatingLyricContextWindow(cues: five, index: 2, n: 1), <String>[
        '行1',
        '行2',
        '行3',
      ]);
      expect(floatingLyricContextWindow(cues: five, index: 2, n: 2), <String>[
        '行0',
        '行1',
        '行2',
        '行3',
    ...
    test('头部不足只显示可用行（不留空）', () {
      expect(floatingLyricContextWindow(cues: five, index: 0, n: 2), <String>[
        '行0',
        '行1',
        '行2',
      ]);
    ...
    test('尾部不足只显示可用行（不留空）', () {
      expect(floatingLyricContextWindow(cues: five, index: 4, n: 2), <String>[
        '行2',
        '行3',
        '行4',
      ]);
    ...
    test('n 超过可用行数=夹取整表', () {
      expect(floatingLyricContextWindow(cues: five, index: 2, n: 99), <String>[
        '行0',
        '行1',
        '行2',
        '行3',
    ...
    test('n<0 被夹到 0=只当前行', () {
      expect(floatingLyricContextWindow(cues: five, index: 2, n: -3), <String>[
        '行2',
      ]);
    });
  });
