  ...
  test(
    ...
    () async {
      ...
      expect(
        ...
        isNot(1),
        reason:
            'the tick-updated live index does not reflect the restored '
      ...
      expect(
        controller.allBookCueIdxAtPosition,
        1,
        reason:
            'the saved position 1000ms falls inside cue(1000), whose '
            'all-book index is 1 — the line the lyrics page must open on',
      );
    },
  );

  test('reopen at position 0: window anchors to the first line', () async {
    final AudiobookPlayerController controller = await loadedAt(
      positionMs: 0,
      cues: <AudioCue>[cue(0), cue(1000), cue(2000)],
  ...
  test(
    ...
    () async {
      ...
      expect(
        ...
        2,
        reason:
            'position 2500ms falls inside cue(2000) (2000..3000), '
            'all-book index 2',
      );
    },
  );
