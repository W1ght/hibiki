...
File _find(List<String> candidates) => candidates
    .map(File.new)
    .firstWhere(
      (File f) => f.existsSync(),
...
void main() {
  test('Windows fork extracts CFSTR_INETURLW on URL drag (TODO-1306)', () {
    ...
    expect(
      RegExp(r'if\s*\(list\.empty\(\)\)').hasMatch(src),
      isTrue,
