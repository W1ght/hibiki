...
void main() {
  test(
    'resource info-hash dedupe prefers provider priority before seeders',
    () {
      final List<VideoResourceCandidate> result =
          deduplicateVideoResources(<VideoResourceCandidate>[
  ...
  test('subtitle dedupe prefers priority and returns priority order', () {
    final List<VideoSubtitleCandidate> result =
        deduplicateVideoSubtitles(<VideoSubtitleCandidate>[
