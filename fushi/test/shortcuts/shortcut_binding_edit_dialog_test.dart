...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        find.text(
          t.shortcut_conflict(s: t.shortcut_action_reader_toggle_chrome),
        ),
        findsOneWidget,
      );
    },
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      const InputBinding pageDown = InputBinding(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.tap(
        find.descendant(of: pageDownChip, matching: find.byIcon(Icons.close)),
      );
      await tester.pumpAndSettle();
      await tester.tap(find.text('OK').last);
      await tester.pumpAndSettle();
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Finder dpadChip = find.widgetWithText(
        FushiTagChip,
        GamepadButton.dpadRight.label,
      );
      expect(dpadChip, findsOneWidget);
      await tester.tap(
        find.descendant(of: dpadChip, matching: find.byIcon(Icons.close)),
      );
      await tester.pumpAndSettle();
      await tester.tap(find.text('OK').last);
      await tester.pumpAndSettle();
