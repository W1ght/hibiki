...
void main() {
  test(
    'every mapped asset file exists on disk under assets/gamepad/<brand>/',
    () {
  ...
  test(
    'Xbox and Switch cover all 17 buttons; PlayStation covers 16 (no guide)',
    () {
      int xbox = 0;
      int ps = 0;
      int nsw = 0;
