  ...
  test(
    ...
    () {
      ...
      expect(
        ...
        isTrue,
        reason:
            'BUG-207 回归：loadShortcutRegistry( 出现在 source.initialise() 之前 —— '
      ...
      final int lastFutureWaitIdx = beforeLoad.lastIndexOf(
        'await Future.wait(',
      );
      expect(
        ...
        isTrue,
        reason:
            'source.initialise() 必须在一段 await Future.wait(...) 内被等待，'
