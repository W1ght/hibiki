...
void main() {
  group('AudioSourceConfig', () {
    test('legacy URLs become enabled remote audio sources', () {
      final List<AudioSourceConfig> sources = AudioSourceConfig.fromLegacyUrls(
        <String>[
    ...
    test(
      'round trips multiple local and remote sources plus Hibiki remote',
      () {
