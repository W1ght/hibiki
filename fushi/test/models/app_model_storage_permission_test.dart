...
void main() {
  ...
  group('BUG-1209 storage permission never drags the camera along', () {
    test(
      'storage not granted: requests storage only, never the camera',
      () async {
        ...
        expect(permission.calls, <String>[
          'has:storage',
          'request:storage',
    ...
    test(
      'storage already granted: short-circuits without asking anything',
      () async {
