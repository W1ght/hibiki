...
Future<void> _seedBook(FushiDatabase db, String bookKey) => db.insertEpubBook(
...
void main() {
  ...
  group('mergeRemoteVideoTags', () {
    test('视频标签 pull + remove-wins 防复活', () async {
      ...
      await db.mergeRemoteVideoTags(
        'video/v1',
        remoteAddedAt: <String, int>{'アニメ': 10},
      );
      expect(
        (await db.getTagsForVideoBook(
          'video/v1',
