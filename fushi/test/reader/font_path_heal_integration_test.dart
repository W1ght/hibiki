...
void main() {
  ...
  test(
    'relocates stale catalog + shadow paths onto present files and persists',
    () async {
      // Real font files present in the CURRENT dir under their basenames.
      final String kleeNew = p.join(
        fontsDir.path,
        'Klee One_1782285150702.ttf',
      );
      final String notoNew = p.join(
        fontsDir.path,
        'Noto Sans SC_1781248919842.ttf',
      );
