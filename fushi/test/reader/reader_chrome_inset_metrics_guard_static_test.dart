...
void main() {
  test('paginated chrome inset changes invalidate cached pagination metrics', () {
    ...
    final int inFlightReturn = function.indexOf(
  ...
  test(
    'partial terminal page uses the browser physical endpoint exactly once',
    () {
      final String source = File(
        'lib/src/reader/reader_pagination_scripts.dart',
      ).readAsStringSync();
      ...
      expect(
        paginate,
        contains(
          'if (targetForward > maxAlignedScroll) '
