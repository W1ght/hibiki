...
void main() {
  test(
    'top reading progress wraps text in a theme-following frosted layer',
    () {
      ...
      expect(
        ...
        contains('withValues('),
        reason:
            'frosted fill must stay translucent, not an opaque block that '
      ...
      expect(
        ...
        reason:
            'the progress Text (fushi_progress) must remain inside the pill',
      );
      expect(
        body,
