...
void main() {
  group('selectUpdateReleaseForCurrentPlatform', () {
    test(
      'debug Windows skips a newer APK-only release and selects setup',
      () async {
            ...
            await selectUpdateReleaseForCurrentPlatform(
              <Map<String, dynamic>>[
                _release(
                  ...
                  prerelease: true,
                  assets: <String>['fushi-0.5.1-debug.20-abc1234-debug.apk'],
                ),
                _release(
                  tag: 'v0.5.1-debug.19+abc1234',
                  prerelease: true,
                  assets: <String>['fushi-0.5.1-debug.19-windows-setup.exe'],
                ),
              ],
    ...
    test(
      'debug Android skips a newer Windows-only release and selects APK',
      () async {
        final UpdateReleaseSelection? selected =
            await selectUpdateReleaseForCurrentPlatform(
              <Map<String, dynamic>>[
                _release(
                  tag: 'v0.5.1-debug.20+abc1234',
                  prerelease: true,
                  assets: <String>['fushi-0.5.1-debug.20-windows-setup.exe'],
                ),
                _release(
                  tag: 'v0.5.1-debug.19+abc1234',
                  prerelease: true,
                  assets: <String>['fushi-0.5.1-debug.19-abc1234-debug.apk'],
                ),
              ],
              currentVersion: '0.5.0',
              channel: UpdateChannel.debug,
    ...
    test(
      'debug Windows returns null when newer releases are APK-only',
      () async {
        final UpdateReleaseSelection? selected =
            await selectUpdateReleaseForCurrentPlatform(
              <Map<String, dynamic>>[
                _release(
                  ...
                  prerelease: true,
                  assets: <String>['fushi-0.5.5-debug.55-abc1234-debug.apk'],
                ),
              ],
    ...
    test(
      'debug Android returns null when newer releases are Windows-only',
      () async {
        final UpdateReleaseSelection? selected =
            await selectUpdateReleaseForCurrentPlatform(
              <Map<String, dynamic>>[
                _release(
                  tag: 'v0.5.5-debug.55+abc1234',
                  prerelease: true,
                  assets: <String>['fushi-0.5.5-debug.55-windows-setup.exe'],
                ),
              ],
              currentVersion: '0.5.5-debug.4',
              channel: UpdateChannel.debug,
    ...
    test(
      'debug combined release lets each platform choose its own asset',
      () async {
    ...
    test(
      'unsupported platforms still fall back to opening the release page',
      () async {
        final UpdateReleaseSelection? selected =
            await selectUpdateReleaseForCurrentPlatform(
              <Map<String, dynamic>>[
    ...
    test(
      'beta channel ignores debug releases with matching platform assets',
      () async {
        final UpdateReleaseSelection? selected =
            await selectUpdateReleaseForCurrentPlatform(
              <Map<String, dynamic>>[
                ...
                _release(
                  tag: 'v0.5.1-beta.19',
                  prerelease: true,
                  assets: <String>['fushi-0.5.1-windows-setup.exe'],
                ),
              ],
              currentVersion: '0.5.0',
    ...
    test(
      'stable channel ignores prereleases with matching platform assets',
      () async {
        final UpdateReleaseSelection? selected =
            await selectUpdateReleaseForCurrentPlatform(
              <Map<String, dynamic>>[
                _release(
                  ...
                  prerelease: true,
                  assets: <String>['fushi-0.5.2-debug.20-windows-setup.exe'],
                ),
                _release(
                  tag: 'v0.5.2',
                  prerelease: false,
                  assets: <String>['fushi-0.5.2-windows-setup.exe'],
                ),
              ],
