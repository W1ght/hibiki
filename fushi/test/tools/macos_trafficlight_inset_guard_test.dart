...
void main() {
  test('kMacTitleBarHeight is a positive titlebar reserve (BUG-869)', () {
    ...
    final RegExp decl = RegExp(
      r'const\s+double\s+kMacTitleBarHeight\s*=\s*([0-9.]+)\s*;',
    );
    ...
    expect(
      ...
      isNotNull,
      reason:
          'kMacTitleBarHeight must be defined in adaptive_platform.dart '
    ...
    expect(
      ...
      reason:
          'kMacTitleBarHeight must be tall enough to clear the traffic '
  ...
  test(
    ...
    () {
      ...
      expect(
        ...
        reason:
            'Both _buildDesktopLayout Scaffolds (settings full-screen and '
