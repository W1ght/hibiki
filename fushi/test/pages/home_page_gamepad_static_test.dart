...
void main() {
  test(
    'HomePage gives focused gamepad actions priority over arrow fallback',
    () {
      ...
      final int arrowFallbackIndex = source.indexOf(
      ...
      expect(
        ...
        reason:
            'Native D-pad/gameButton events must reach the focused widget '
