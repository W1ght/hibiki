...
void main() {
  ...
  test('② collection_exporter 提供制卡句导出管线 buildMinedExport', () {
    final String src = File(
      'lib/src/utils/misc/collection_exporter.dart',
    ).readAsStringSync();
  ...
  test(
    '③ collections_page 经 getAllMinedSentences 导出 + MD3 抽屉 + allMined 范围',
    () {
      final String src = File(
  ...
  test('④ 不回归 BUG-123/125：竖排选区 ruby class 分流机制仍在（与 ☆ 复活无耦合）', () {
    ...
    expect(
      css.contains('ruby.fushi-selection-ruby-active > rt'),
      isFalse,
