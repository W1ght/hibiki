...
void main() {
  ...
  test(
    '_initRemote maps info.episodes into _episodes (no longer always empty)',
    () {
  ...
  test(
    'remote episode switch streams by episodeIndex (DB-only, not host path)',
    () {
