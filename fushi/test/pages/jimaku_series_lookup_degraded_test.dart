...
void main() {
  ...
  Future<void> pump(WidgetTester tester, {required bool degraded}) async {
  ...
  testWidgets('AniList 没问上时，结果区如实告知可能混入其他季 + 给重试', (WidgetTester tester) async {
