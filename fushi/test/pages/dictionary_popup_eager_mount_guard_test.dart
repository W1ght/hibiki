...
void main() {
  ...
  test(
    '_buildBody mounts the WebView during searching, not only with results',
    () {
      ...
      // having entries.
      expect(
        body.contains('hasRenderableResults || isSearching'),
        isTrue,
      ...
      // ready yet.
      expect(
        body.contains('result ?? kPopupSearchingPlaceholderResult'),
        isTrue,
