...
void main() {
  ...
  test('parkedPopupLayer 把隐藏热槽停到屏幕右外侧（收口的单一真相）', () {
    ...
    expect(
      src.contains('visible ? pos.left : screen.width + 8'),
      isTrue,
  ...
  test('reader base_source_page: 经 parkedPopupLayer + Stack Clip.none', () {
    ...
    expect(
      src.contains('clipBehavior: Clip.none'),
      isTrue,
  ...
  test('app 外查词窗 popup_dictionary_page: 隐藏层经 parkedPopupLayer 停真屏外', () {
    ...
    expect(
      ...
      isTrue,
      reason:
          'TODO-1379：卡片局部坐标 cardWidth+8 停靠在窄卡/宽屏时仍在屏内，'
