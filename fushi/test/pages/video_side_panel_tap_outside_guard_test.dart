...
void main() {
  ...
  test('③ VideoSubtitleJumpPanel renders the Icons.close X button again '
    ...
    expect(
      ...
      isTrue,
      reason:
          'VideoSubtitleJumpPanel header must render the X close button '
          'again (TODO-637)',
    );
    expect(
      src.contains('onPressed: widget.onClose'),
      isTrue,
