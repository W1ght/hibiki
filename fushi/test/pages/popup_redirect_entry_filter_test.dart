...
void main() {
  test('popup hides redirect-only glossaries using their data shape', () async {
    ...
    expect(
      ...
      0,
      reason:
          'redirect filter behavior test failed.\n'
          'stdout:\n${result.stdout}\nstderr:\n${result.stderr}',
    );
  ...
  test(
    'every glossary grouping/render path applies the redirect predicate',
    () {
      ...
      expect(
        ...
        4,
        reason:
            'display, mining, main grouping, and incremental grouping must '
  ...
  test('all shipped popup.js mirrors remain byte-identical', () {
    ...
    final List<List<int>> bytes = mirrors
