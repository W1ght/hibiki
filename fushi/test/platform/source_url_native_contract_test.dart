...
void main() {
  test(
    ...
    () {
      ...
      final XmlElement main = manifest.findAllElements('activity').singleWhere(
            (XmlElement node) =>
      ...
      final XmlElement sourceFilter =
          main.findElements('intent-filter').singleWhere(
                (XmlElement filter) => filter.findElements('data').any(
                      (XmlElement data) =>
