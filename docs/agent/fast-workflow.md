...
一条命令跑完，**当前基线 239 tests**（2026-08-10，`origin/develop@0203640035` 实测）——比争论「这条该不该跑」便宜得多，所以**不要挑，整批跑**：
...
| **239** | **35** | BUG-1489 给 `media_kind_persistence_guard` 补冻结迁移登记出口 + 10 条合成语料自校验 + 2 条登记自校验（3→15，**当前基线**） |
