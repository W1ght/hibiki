...
| BUG | 修复 | 测试 | 标题 |
|---|:--:|:--:|---|
| [BUG-2429](bugs/BUG-2429-galgame-lookups-mined-as-book.md) | ✅ | ✅ | galgame 查词/制卡/收藏被记成 book 来源，游戏统计缺四个指标 |
| [BUG-2428](bugs/BUG-2428-stats-tabs-layout-not-unified.md) | ✅ | ✅ | 统计中心阅读 tab 独有页面级限宽，四个 tab 布局不统一 |
