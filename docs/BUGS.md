...
| BUG | 修复 | 测试 | 标题 |
|---|:--:|:--:|---|
| [BUG-756](bugs/BUG-756-lyrics-audio-follow-snap.md) | ✅ | ✅ | 歌词模式音频跟随失效（followAudio 门控 + snap 回中不生效） |
| [BUG-755](bugs/BUG-755-lyrics-input-no-chrome-no-esc.md) | ✅ | ✅ | 歌词模式唤不出隐藏底栏 + esc 退不出 |
