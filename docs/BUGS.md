...
| [BUG-1092](bugs/BUG-1092-gal-loopback-line-audio-off-by-one.md) | ✅ | ✅ | 降级到系统 Loopback 时逐行语音永远配到上一句 |
...
| [BUG-1091](bugs/BUG-1091-gal-degrade-unrecoverable-engine-pcm.md) | ✅ | ✅ | galgame 刚启动就误报「降级运行 · engine_pcm_unavailable」，且永远回不到引擎 PCM |
