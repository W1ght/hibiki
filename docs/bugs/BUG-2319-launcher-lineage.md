...
- **验证**：2026-09-08，Windows MSVC x86/x64 Release 全部构建退出 0，两架构 CTest 各 84/84；manifest 22/22、结构 48/48、workflow（含生产 replay）6/6，manifest/profile 生成检查通过。`bug.dart check` 本地不变式通过，跨工作区原有 84 组撞号警告不涉及 BUG-2319。未运行非 Windows 构建。
