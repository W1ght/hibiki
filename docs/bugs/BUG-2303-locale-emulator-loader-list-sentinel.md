## BUG-2303 · Locale Emulator在早期模块初始化链表头上解引用导致Rewrite启动崩溃
...
- **备注**：构建脚本、工具哈希及 PE 验证位于 `native/galgame_hook/third_party/locale_emulator/`。后续版本语言、时区名称和启动器谱系分别记录 BUG-2317、BUG-2318、BUG-2319；没有修改游戏或全局系统区域。
