## BUG-2310 · Windows Flutter ChildAtIndex 枚举空子节点时访问冲突
...
- **备注**：本问题与 [BUG-2302](BUG-2302-windows-uia-flutter-host-crash.md) 属于同一 Windows 可访问性域，但崩点与失效对象不同，不能合并为同一已知根因。
...
- `cdb-previous73368-comparison.log`：旧 BUG-2302 的准确属性访问栈，作为区别证据。
