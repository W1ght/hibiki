## BUG-2091 · 被抢占的旧轮次撤回 attached provider 认领，与注入侧 registry 形成活锁
...
- **关联**：BUG-2090（WoH 原生几何不可用，attached 因此成为该引擎唯一通路）、BUG-2053（attached 表面已实现吞点击 / Shift 悬浮 / 关弹窗不推进 / 带图与整句音频四项行为）。
