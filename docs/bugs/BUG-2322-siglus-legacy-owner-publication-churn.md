## BUG-2322 · 旧版Siglus重复发布正文对象导致查词弹窗闪退
...
2026-09-08 新 Rewrite PID 48540 从原始 Start.exe 经转区启动，实际加载修正 DLL SHA-256 `C38766F11E53DABB35D53A2489112108F5307B3D97A1A98B5017A7C2B0CFAFFB`。Fushi 本体在游戏出现前另有 BUG-2302 崩溃，恢复 Fushi 后经正常附着和线程选择验证，不能将此会话写成无中断启动全程通过。
