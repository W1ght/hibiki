...
- **[x] ① 已修复** — Runner / Podfile / HoshiDicts FFI 默认 deployment target 统一升到 iOS 15.0；Pod post_install 强制所有 Pod target 也使用 15.0，避免第三方 podspec 写入 9/10/12/13 后被 Xcode 27 拒绝。（提交：待回填）
