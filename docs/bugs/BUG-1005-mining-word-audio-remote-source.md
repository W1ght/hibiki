## BUG-1005 · 制卡缺单词音频·扩展needsAudio门+制卡器忽略远程发音源
- **报告**：2026-07-22（用户：互联视频制卡「缺少单词音频」，与 [[BUG-1004]] 同轮报告）
...
- **备注**：
  ...
  - 关联 [[BUG-631]]（播放侧同类修复，本 bug 复用其 `resolveConfigured` 全源真相）、[[BUG-1004]]（同轮报告的句子音频/制卡失败，独立根因）。
