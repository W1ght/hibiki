## BUG-2308 · Siglus 语音资源缺少正文事件身份，配对依赖时间窗
...
同轮发现首次选择线程回捞的 seq1 未自动挂音频，这是消费端 [BUG-2311](BUG-2311-selected-thread-history-resource-pairing.md)，不再归因为 native 没有事件身份。该修复集成为 `98884fa55e`，尚待新宿主原路径回归。构建、运行身份和各项限制详见 [原路径报告](../reviews/2026-09-07-siglus-expanded-trials.md)。本条仍保留跨编译 family、重复句/读档/重播和声音分类未验证的范围，支持矩阵未升级。
