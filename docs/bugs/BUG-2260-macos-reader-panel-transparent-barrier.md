...
- **[x] ② 已加自动化测试** — `fushi/test/tools/bug_2260_reader_side_sheet_dismiss_guard_test.dart`（6 例：纯判据三态行为 + 源码守卫「旗在抽屉两侧翻且 finally 复位」「七条 tap 桥都接了门控」「门控走 maybePop 而非裸 pop」）。
