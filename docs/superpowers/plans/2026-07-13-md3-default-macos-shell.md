...
**Files:**
- Create: `docs/bugs/BUG-781-md3-macos-double-shell.md` through the bug tool
...
- Produces: `BUG-781`, whose two checkboxes are completed only after code and tests land
...
Expected: `docs/bugs/BUG-781-md3-macos-double-shell.md`, plus an automatically rebuilt `docs/BUGS.md` index.
...
```bash
git add docs/bugs/BUG-781-md3-macos-double-shell.md docs/BUGS.md
...
**Files:**
- Modify: `docs/bugs/BUG-781-md3-macos-double-shell.md`
