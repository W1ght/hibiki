...
class GalgameSessions extends Table {
  ...
  /// v100：产生本次游玩时激活的 Profile（`profiles.id`；0 = 库里还没有 Profile
...
class StudySegments extends Table {
  ...
  /// v100（统计按 Profile 隔离）：开段时激活的 Profile（`profiles.id`）。
  ///
...
///
/// 自 v100 起碑也按 Profile 分区（主键加 [profileId]，重建表）——A Profile 删某书
