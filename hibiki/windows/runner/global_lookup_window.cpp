...
void GlobalLookupWindow::ConfigureWebView() {
  ...
  webview_->add_NavigationCompleted(
      Callback<ICoreWebView2NavigationCompletedEventHandler>(
          [this](ICoreWebView2*,
            ...
            webview_ready_ = true;
            // TODO-1268 (BUG-685) -- a recovery rebuild (RecoverDeadWebView)
  ...
  // TODO-1268 (BUG-685) -- self-heal a dead overlay WebView2 process tree.
  //
...
void GlobalLookupWindow::RenderJson(const std::string& full_script) {
  ...
  // TODO-1268 (BUG-685) -- deterministic dead-surface detection. The overlay
...
// TODO-1268 (BUG-685) -- rebuild a dead overlay WebView2 in place.
//
