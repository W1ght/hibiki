...
class _HibikiLogPanelState extends State<HibikiLogPanel> {
  ...
  // TODO-1380/BUG-688：右键/长按菜单的自持锚点——面板内最近一次 pointer down 的
  ...
  // 即崩（Null check operator，崩溃栈见 docs/bugs/BUG-688）。菜单只能由面板内
  ...
  Widget _buildContextMenu(
    ...
    return AdaptiveTextSelectionToolbar.buttonItems(
      // TODO-1380/BUG-688：锚点自持（[_lastPointerDownGlobalPosition]），不读
