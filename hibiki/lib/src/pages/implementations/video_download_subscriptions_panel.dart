...
/// Schema-v71 订阅真相源的管理面板。旧 JSON 只由一次性 importer 读取，页面不再
...
class _VideoDownloadSubscriptionsPanelState
  ...
  Widget build(BuildContext context) {
    final HibikiDatabase database = ref.read(appProvider).database;
...
class _VideoDownloadSubscriptionCard extends StatelessWidget {
  ...
  String _formatTime(int? milliseconds) {
    ...
    return HibikiTimeFormat.dateHourMinute(
