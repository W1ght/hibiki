...
''';
  ...
  /// BUG-1091：等待 JS 真实播放结果的 pending 表。`evaluateJavascript` 不会 await
  ...
  /// never lose auto-read (Never break userspace, BUG-1091).
  ...
  Widget build(BuildContext context) {
    ...
    final Widget webView = InAppWebView(
      ...
      onWebViewCreated: (controller) {
        ...
        // BUG-1091：单词音频真实播放结果回传（见 playWordAudioUrl）。args =
