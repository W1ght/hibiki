...
class _VideoSubtitleOverlayState extends State<VideoSubtitleOverlay> {
  ...
  /// TODO-1372/BUG-686：跨帧的组内槽位表——「层前缀|分组键」→ 槽位列表（**锚点侧在前**：
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (BuildContext context, _) {
        ...
        // TODO-1372/BUG-686：清扫「组内已无任何在屏 cue」的槽位状态——整组离场即重置，
  ...
  ///
  /// TODO-1372/BUG-686 语义归一：渲染路径把「anchor 缺省」当底部居中（[_alignFor] /
  ...
  /// TODO-1372/BUG-686：把一组的当前活动 cue 对齐进跨帧槽位表（不变量见 [_groupSlots]），
  ...
  Widget _positionCueGroup(
    ...
    // TODO-1372/BUG-686：组内跨帧稳定槽位（锚点侧在前，不变量见 [_groupSlots]）。Column
...
/// [_VideoSubtitleOverlayState._groupSlots] 的一格（TODO-1372/BUG-686）：槽主 cue + 是否
