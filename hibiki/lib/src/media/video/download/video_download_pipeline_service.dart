...
import 'package:hibiki/src/media/torrent/torrent_add_coordinator.dart';
...
import 'package:hibiki/src/media/video/download/video_download_organizer.dart';
...
import 'package:hibiki/src/media/video/download/video_subtitle_registry.dart';
...
/// Resume ids that remain owned by the v71 pipeline after legacy JSON files
...
/// v71 持久任务执行器。每轮只推进一个阶段，阶段意图和文件级检查点先落 Drift，
...
class VideoDownloadPipelineService {
  ...
  /// Reconciles a pre-v71 plan against its original backend location. Legacy
  ...
  /// This mirrors the pre-v71 workflow: a video that already has any sidecar
