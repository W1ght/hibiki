...
class BackupService {
  ...
  ///    no content to follow, never wanted on another device (BUG-831).
  ...
  static Future<void> _stripOrphanUserDataTables(
    ...
    try {
      ...
      // private usage traces (BUG-831) — no content to follow, never wanted on
      ...
      // content it indexes (BUG-831). Its `media_kind` is 'book' | 'video'; drop
