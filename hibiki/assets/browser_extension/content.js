...
console.log('[Hibiki] content script v44 loaded (TODO-1361: wait seek settle + video advancing before Netflix clip record, BUG-683)');
  ...
  try {
    for (const q of items) {
      ...
      try {
        ...
        // TODO-1361 ⑤（BUG-683 seek-in-then-out 跳卡根因）：seek 落点后先确认 seek 真落到 <video>
        ...
        // TODO-1361 ⑤（BUG-683）：以「currentTime 真正前进」为唯一判据有界等视频开录，期间反复补 play()。
...
// TODO-1361 ⑤（BUG-683）：有界等 <video> 元素层 seek 真正落定——currentTime 逼近目标且不再
...
// TODO-1361 ⑤（BUG-683）：有界等 video 真正在播放并前进（currentTime 相对开录基线单调增长），
