...
void main() {
  ...
  // TODO-1388 / BUG-702: 制卡(mining)路径过去只有裸
  ...
  group('resolveCoverFilePath 制卡封面 case-insensitive 解析对称 (TODO-1388/BUG-702)',
      () {
    late Directory tempDir;
    ...
    test(
      ...
      expect(resolved, isNotNull,
          reason: '封面在盘上存在，只是大小写不符——制卡不得解析成 null(TODO-1388/BUG-702)');
  ...
  group('模拟大小写敏感 FS: 声明封面按小写探测落空→case-insensitive 兜底命中 (BUG-702)', () {
  ...
  group('制卡路径接线守卫: mining 复用 resolveCoverFilePath 而非裸 existsSync (BUG-702)',
      () {
