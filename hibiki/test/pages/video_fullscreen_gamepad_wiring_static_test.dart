...
/// BUG-686（TODO-1378）：视频全屏路由内手柄只有 B 可用、A/D-pad 静默 no-op 的
/// **页面接线**源码守卫。
///
...
void main() {
  ...
  test('全屏路由 pageBuilder 内容必须包进 _wrapVideoGamepadControls（BUG-686）', () {
    ...
    expect(
      ...
      reason: '全屏路由子树必须持有与窗口模式同一个 GamepadButtonIntent 处理层，'
          ...
          '（BUG-686 根因）。若重构改了包裹方式，请保证等价的 Actions 仍是全屏'
