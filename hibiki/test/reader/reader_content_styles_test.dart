  ...
  group('ReaderContentStyles audiobook highlight lane', () {
    ...
    test('vertical sasayaki text spans draw only the base text lane', () async {
      ...
      expect(
        ...
        reason: 'TODO-1371/BUG-685：active 态禁止改写盒模型。旧 line-height:1 !important '
    ...
    test('active highlight blocks are paint-only in both writing modes',
        () async {
      // TODO-1371/BUG-685 守卫：跟随句/查词/收藏的运行时 toggle 高亮（-active 类、
          ...
          for (final String line in block.group(2)!.split('\n')) {
            ...
            expect(
              ...
              reason: '[$mode] 高亮 toggle 规则出现非绘制层属性 `$property`（选择器：'
                  ...
                  '（TODO-1371/BUG-685）；确属纯绘制属性再显式加进 allowlist',
            );
          }
        }
